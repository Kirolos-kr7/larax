<div class="bg-gray-800 flex flex-col p-4 rounded">
    <div class="flex justify-between">
        <a href="/listing/{{ $listing['id'] }}" class="p-1 -m-1 rounded pb-0 mb-1">
    ...
    <span class="items-center gap-1 my-2 sm:hidden flex">
        <svg class="w-5 h-5" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z">
            </path>
    ...
    <div class="flex justify-between items-end gap-3 my-1 flex-1">
